...
if __name__ == "__main__":
    ...
    parser.add_argument("--val_input_language_path", type=str, default="data_files/encodings_val.txt")
    parser.add_argument("--val_output_language_path", type=str, default="data_files/decodings_val.txt")
